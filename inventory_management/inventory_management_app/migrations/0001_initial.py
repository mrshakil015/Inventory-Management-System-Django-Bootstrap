    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Inventory Manager', 'Inventory Manager'), ('Billing Staff', 'Billing Staff')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_user', models.ForeignKey(blank=True, help_text='If Customer already have an account. Then select customer.', null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory_management_app.customermodel')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeModel',
            fields=[
                ...
                ('employee_user', models.OneToOneField(max_length=40, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='MedicineModel',
            fields=[
                ...
                ('pack_size', models.PositiveIntegerField(default=0, help_text='Pack size unit must be the ml/gm/x.', null=True)),
                ('total_case_pack', models.PositiveIntegerField(blank=True, default=0, null=True)),
                ('stocks', models.CharField(choices=[('Available', 'Available'), ('Out of Stock', 'Out of Stock')], default='Out of Stock', max_length=20, null=True)),
                ...
                ('pack_units', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='medicine_unit', to='inventory_management_app.medicineunitmodel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='BillingItemModel',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('medicine_quantity', models.IntegerField(default=0, help_text='Add the Medicine quantity into ml/gm', null=True)),
                ...
                ('billing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='billing_items', to='inventory_management_app.billingmodel')),
                ('medicine', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='medicine_billings', to='inventory_management_app.medicinemodel')),
            ],
        ),
        migrations.CreateModel(
